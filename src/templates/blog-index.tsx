  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Read the latest articles and insights about headless CMS, content management, and web development." />
      </Helmet>
          ...
          <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 md:pt-16 pb-8 md:pb-12">
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Discover insights, tutorials, and best practices for modern content management and web development.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between mb-8">
              <p className="text-sm text-muted-foreground">
                Showing {((currentPage - 1) * 15) + 1} - {Math.min(currentPage * 15, allMdx.totalCount)} of {allMdx.totalCount} articles
              </p>
              {totalPages > 1 && (
                <p className="text-sm text-muted-foreground">
            ...
            {posts.length === 0 ? (
              <div className="text-center py-12">
                <h2 className="text-2xl font-semibold text-muted-foreground mb-4">No blog posts found</h2>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          {post.frontmatter.publishedAt && (
                            <div className="flex items-center gap-1">
                              ...
                              <span>{new Date(post.frontmatter.publishedAt).toLocaleDateString()}</span>
                            </div>
                          )}
                        </div>
                        <span className="text-xs">{post.timeToRead} min read</span>
                      </div>
